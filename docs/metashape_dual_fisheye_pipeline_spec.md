...
1. OSV / 独自 MP4（2 video stream: front / back）を入力
...
ffmpeg -i input.mp4 -map 0:v:0 -vsync 0 work/extracted/front_raw/F_%06d.jpg
ffmpeg -i input.mp4 -map 0:v:1 -vsync 0 work/extracted/back_raw/B_%06d.jpg
```
